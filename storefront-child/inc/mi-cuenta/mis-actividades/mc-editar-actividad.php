...
function pagina_editar_actividad_shortcode() {
    ...
    <div class="pagina-grid-3366">
        ...
        <div class="pagina-columna66">
            ...
            <?php echo do_shortcode('[contenido_editar_actividad]'); ?>
...
add_shortcode('pagina_editar_actividad', 'pagina_editar_actividad_shortcode');
