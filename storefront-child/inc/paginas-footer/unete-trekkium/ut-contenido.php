...
function ut_contenido_shortcode() {
    ...
    <section class="unete-trekkium">

        <div class="ut-header">
            <div class="ut-image">
                <img src="https://trekkium.com/wp-content/uploads/2025/10/Alpine-climb-training-53.jpg" alt="Guías de montaña Trekkium">
            </div>
            <h2>¿Eres guía de montaña profesional?</h2>
            <p class="ut-subtitle">¿Te gustaría formar parte de nuestro equipo de guías?</p>
        </div>
