<?php
function tc_aviso_legal_shortcode() {
    ob_start();
    ?>
        ...
        <div class="tc-contenido">
            ...
            <div class="tc-seccion">
                <div class="tc-pregunta">
                    ...
                    <span class="tc-texto">1. Datos identificativos</span>
                </div>
                <div class="tc-respuesta">
                    <p>En cumplimiento de lo dispuesto en la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y de Comercio Electrónico (LSSI-CE), se facilita a continuación la información general de este sitio web:</p>
                    <p><strong>Titular:</strong> Antonio Zamorano Torres<br>
            ...
            <div class="tc-seccion">
                <div class="tc-pregunta">
                    <span class="tc-icon">></span>
                    <span class="tc-texto">4. Propiedad intelectual e industrial</span>
                </div>
                <div class="tc-respuesta">
            ...
            <div class="tc-seccion">
                <div class="tc-pregunta">
                    <span class="tc-icon">></span>
                    <span class="tc-texto">5. Responsabilidad de los contenidos</span>
                </div>
                <div class="tc-respuesta">
                    <p>Trekkium no garantiza la exactitud, veracidad o actualización permanente de los contenidos ofrecidos.<br>
                    Aunque se procura que la información sea precisa y actual, puede contener errores tipográficos o imprecisiones técnicas.</p>
                    <p>Trekkium no se responsabiliza de:</p>
                    <ul class="tc-list">
                        <li>El uso que los usuarios hagan del material publicado.</li>
                        <li>Los daños o perjuicios derivados del acceso, uso o imposibilidad de uso del sitio.</li>
                        <li>Las actividades, servicios o comportamientos de los guías colaboradores o entidades organizadoras que anuncian y ejecutan las actividades.</li>
                    </ul>
                    <p>Los guías son responsables de la correcta ejecución de las actividades contratadas, así como de cumplir con los requisitos legales y de seguridad exigidos por la normativa vigente.</p>
                </div>
            </div>
            ...
            <div class="tc-seccion">
                <div class="tc-pregunta">
                    <span class="tc-icon">></span>
                    <span class="tc-texto">6. Enlaces externos</span>
                </div>
                <div class="tc-respuesta">
                    <p>El sitio web puede contener enlaces a sitios de terceros.<br>
                    Trekkium no asume ninguna responsabilidad sobre los contenidos, informaciones o servicios que pudieran aparecer en dichos sitios, que tendrán exclusivamente carácter informativo.</p>
                </div>
            </div>
            ...
            <div class="tc-seccion">
                <div class="tc-pregunta">
                    <span class="tc-icon">></span>
                    <span class="tc-texto">7. Política de enlaces a Trekkium</span>
                </div>
                <div class="tc-respuesta">
            ...
            <div class="tc-seccion">
                <div class="tc-pregunta">
                    <span class="tc-icon">></span>
                    <span class="tc-texto">8. Limitación de responsabilidad</span>
                </div>
                <div class="tc-respuesta">
                    <p>Trekkium no será responsable de los daños o perjuicios que pudieran derivarse de interferencias o averías telefónicas, desconexiones en el sistema electrónico, virus informáticos o cualquier otro factor ajeno a su control.<br>
                    El usuario es el único responsable de la evaluación y uso de la información y servicios ofrecidos a través del sitio web.</p>
                </div>
            </div>
...
add_shortcode('tc_aviso_legal', 'tc_aviso_legal_shortcode');
